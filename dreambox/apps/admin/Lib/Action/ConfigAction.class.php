...
class ConfigAction extends AdministratorAction {
	...
	public function register() {
		...
		// 注册协议是否开启
		$this->opt ['register_protocol'] = array (
				1 => L ( 'PUBLIC_OPEN' ),
				0 => L ( 'PUBLIC_CLOSE' ) 
		);
		// 开启，关闭
	 ...
	 * @return void
	 */
	private function _initTabRegister() {
		// Tab选项
		$this->pageTab [] = array (
				'title' => '注册配置',
				'tabHash' => 'register',
				'url' => U ( 'admin/Config/register' ) 
		);
		$this->pageTab [] = array (
				'title' => '注册协议',
				'tabHash' => 'regProtocol',
				'url' => U ( 'admin/Config/regProtocol' ) 
		);
	}
